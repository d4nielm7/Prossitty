...
import { getAllPlaces, getSession, getUserDetails } from "@/app/supabase-server";
import PlaceItem from "./place-item";

export default async function AllPlacesList() {
  const [session, places, userData] = await Promise.all([getSession(), getAllPlaces(), getUserDetails()]);
  return (
