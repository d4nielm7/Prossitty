...
import { CategoryData, PlaceData } from "./user-places";
...
{ tags: string[], categories: { id: string, name: string } };
...
export default function PlaceItem({
    ...
    const [userData, setUserData] = useState<PlaceItemProps["creator"]>(null);
